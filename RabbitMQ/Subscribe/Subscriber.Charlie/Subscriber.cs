    ...
    static void Main(string[] args)
    {
      ...
      switch (Config.Examples.CURRENT_EXAMPLE)
      {
        ...
        case Config.Examples.ROUTING:
          ...
          subscriber.Start(new string[] { Config.Severity.CRITICAL });
          break;
        case Config.Examples.TOPIC:
          Console.Title = Config.Topics.CHARLIE_CONSOLE_TITLE;
          subscriber = new Topics();
          subscriber.Start(new string[] { Config.Topics.FILETYPE_ROUTING_KEY });
          break;
